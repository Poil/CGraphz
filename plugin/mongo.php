...
switch($obj->args['type']) {
	case 'cache_ratio':
		$obj->data_sources = array('value');
                $obj->rrd_title = sprintf('Cache Ratio%s',
                        !empty($obj->args['pinstance']) ? ' ('.$obj->args['pinstance'].')' : '');
		$obj->rrd_vertical = 'Hits';
	break;
	case 'connections':
		$obj->data_sources = array('value');
		$obj->rrd_title = sprintf('Connections%s',
                        !empty($obj->args['pinstance']) ? ' ('.$obj->args['pinstance'].')' : '');
	...
	case 'memory':
		...
		$obj->data_sources = array('value');
		$obj->rrd_title = sprintf('Memory%s',
                        !empty($obj->args['pinstance']) ? ' ('.$obj->args['pinstance'].')' : '');
		$obj->rrd_vertical = 'MB';
	break;
	case 'counter':
                ...
                $obj->heigth = $heigth;
		$obj->data_sources = array('value');
		$obj->rrd_title = sprintf('Counter%s',
                        !empty($obj->args['pinstance']) ? ' ('.$obj->args['pinstance'].')' : '');
		$obj->rrd_vertical = 'Number';
	break;
	case 'percent':
		$obj->data_sources = array('value');
		$obj->rrd_title = sprintf('Lock Ratio Time%s',
                        !empty($obj->args['pinstance']) ? ' ('.$obj->args['pinstance'].')' : '');
		$obj->rrd_vertical = '%';
	break;
	case 'file_size':
		...
		$obj->rrd_title = sprintf('File Size%s',
                        !empty($obj->args['pinstance']) ? ' ('.$obj->args['pinstance'].')' : '');
