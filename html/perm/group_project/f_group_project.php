...
?>
	<form name="f_form_group_project" method="post" action="<?php echo removeqsvar($cur_url, 'f_id_config_project'); ?>">
		...
		<input type="submit" name="f_delete_group_project" id="f_delete_group_project" value="Supprimer" />
	</form>
<?php
} else {
	?> 
	<form name="f_form_group_project" method="post" action="">
		...
		echo '</select>';
		?>
		<input type="submit" name="f_submit_group_project" id="f_submit_group_project" value="Envoyer" />
	</form>
	<?php 
}
?>