...
?>
    <form class="form-horizontal" role="form" name="f_form_group_project" method="post" action="<?php echo removeqsvar($cur_url, 'f_id_config_project'); ?>" onsubmit="return validate_del(this);">
...
<?php
    ...
    ?> 
    <form class="form-horizontal" role="form" name="f_form_group_project" method="post" action="">
        <input type="hidden" name="f_id_auth_group" id="f_id_auth_group" value="<?php echo $cur_group->id_auth_group; ?>" />
