...
<div class="form-group">
	...
	<?php if (isset($cur_server->id_config_server)) { ?>
		<input id="f_server_name" name="f_server_name" value="<?php echo $cur_server->server_name ?>" readonly="readonly" /><br />
	<?php } else { ?>
...
<div class="form-group">
	<div class="col-sm-offset-4 col-sm-6">
		<input class="btn btn-default" type="submit" name="f_submit_server" id="f_submit_server" value="<?php echo SUBMIT ?>" />
	</div>
</div>
</form>
...
<?php if (isset($_GET['f_id_config_server'])) { ?>
	...
	<div class="form-group">
		...
		<div class="col-sm-offset-4 col-sm-6">
			<input class="btn btn-default" type="submit" name="f_del_server" id="f_del_server" value="<?php echo DEL ?>" />
		</div>
	</div>
	</form>
<?php } ?>
