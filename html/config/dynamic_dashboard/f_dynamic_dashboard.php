<form name="f_form_dynamic_dashboard" method="post" action="">
	...
	<input type="submit" name="f_submit_dynamic_dashboard" id="f_submit_dynamic_dashboard" value="Envoyer" />
</form>
...
?>
	<form name="f_form_del_dynamic_dashboard" method="post" action="">
		...
		<input type="submit" name="f_del_dynamic_dashboard" id="f_del_dynamic_dashboard" value="Supprimer" />
	</form>
<?php
}
?>