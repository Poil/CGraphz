...
?>
	<form name="f_form_server_environment" method="post" action="<?php echo removeqsvar($cur_url, 'f_id_config_environment'); ?>">
		...
		<input type="submit" name="f_delete_server_environment" id="f_delete_server_environment" value="Supprimer" />
	</form>
<?php
} else {
	?> 
	<form name="f_formserver_environment_" method="post" action="">
		<input type="hidden" name="f_id_config_server" id="f_id_config_server" value="<?php echo $cur_server->id_config_server; ?>" />
		<label for="f_id_config_environment">Projet</label>
		<?php 
		...
		echo '</select>';
		?>
		<input type="submit" name="f_submit_server_environment" id="f_submit_server_environment" value="Envoyer" />
	</form>
	<?php 
}
?>