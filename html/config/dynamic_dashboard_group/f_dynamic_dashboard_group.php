...
?>
	<form name="f_form_user_group" method="post" action="<?php echo removeqsvar($cur_url, 'f_id_auth_group'); ?>">
		...
		<input type="submit" name="f_delete_dynamic_dashboard_group" id="f_delete_dynamic_dashboard_group" value="Supprimer" />
	</form>
<?php
} else {
	?> 
	<form name="f_form_dynamic_dashboard_group" method="post" action="">
		...
		<input type="submit" name="f_submit_dynamic_dashboard_group" id="f_submit_dynamic_dashboard_group" value="Envoyer" />
	</form>
	<?php 
}
?>