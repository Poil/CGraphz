<form name="f_form_project" method="post" action="<?php echo removeqsvar($cur_url, 'f_id_config_project'); ?>">
	...
	<label for="f_project_description">Description</label>
		<input type="text" name="f_project_description" id="f_project_description" value="<?php echo @$cur_project->project_description; ?>" /><br />
	<input type="submit" name="f_submit_project" id="f_submit_project" value="Envoyer" />
</form>
...
?>
	<form name="f_form_del_project" method="post" action="">
		...
		<input type="submit" name="f_del_project" id="f_del_project" value="Supprimer" />
	</form>
<?php
}
?>