...
?>
	<form name="f_form_user_group" method="post" action="<?php echo removeqsvar($cur_url, 'f_id_auth_group'); ?>">
		...
		<input type="submit" name="f_delete_user_group" id="f_delete_user_group" value="Supprimer" />
	</form>
<?php
} else {
	?> 
	<form name="f_form_user_group" method="post" action="">
		...
		<input type="submit" name="f_submit_user_group" id="f_submit_user_group" value="Envoyer" />
	</form>
	<?php 
}
?>