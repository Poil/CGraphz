<form name="f_form_group_user" method="post" action="<?php echo removeqsvar($cur_url, 'f_id_auth_user'); ?>">
	...
	<label for="f_id_auth_user">Utilisateur</label>
	<?php 
	...
	?>
	<br />
	<label for="f_manager">Manager</label>
	...
	<input type="submit" name="f_submit_group_user" id="f_submit_group_user" value="Envoyer" />
</form>
<?php 
...
?>
	<form name="f_form_group_user" method="post" action="<?php echo removeqsvar($cur_url, 'f_id_auth_user'); ?>">
		...
		<input type="submit" name="f_delete_group_user" id="f_delete_group_user" value="Supprimer" />
	</form>
<?php
}
?>