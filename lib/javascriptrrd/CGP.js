var CGP = (function() {
    ...
    function prepare_draw(id) {
        ...
        var button_timeselector = document.getElementById('f_time_submit');
        button_timeselector.addEventListener("click",
            function(e) {
                if (date_to_ts('f_time_start') < date_to_ts('f_time_end')) {
                    rrdgraph.start =  date_to_ts('f_time_start');
                    rrdgraph.end =  date_to_ts('f_time_end');
                    try {
                    ...
                    alert('NO !!' + date_to_ts('f_time_start')+' < '+date_to_ts('f_time_end'));
                }
            },
        false);
