...
/* public */
	...
	this.DEFAULT_FONT = "'DejaVu Sans Mono', 'Courier', 'Ubuntu Mono'"; //DejaVu Sans Mono ,Bitstream Vera Sans Mono,monospace,Courier', // pt -> pt=px*72/96
	...
	this.TEXT = {	
			DEFAULT: { size: 11, font: this.DEFAULT_FONT, option: this.DEFAULT_OPT_FONT },
			TITLE: { size: 12, font: this.DEFAULT_FONT, option: this.DEFAULT_OPT_FONT },
			AXIS: { size: 10, font: this.DEFAULT_FONT, option: this.DEFAULT_OPT_FONT },
			UNIT: { size: 11, font: this.DEFAULT_FONT, option: this.DEFAULT_OPT_FONT },
			LEGEND: { size: 11, font: this.DEFAULT_FONT, option: this.DEFAULT_OPT_FONT },
