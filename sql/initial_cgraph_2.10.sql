...
CREATE TABLE IF NOT EXISTS `cgraphz`.`auth_user_group` (
  ...
  INDEX `fk_aug_id_auth_group_idx` (`id_auth_group` ASC),
  INDEX `fk_aug_id_auth_user_idx` (`id_auth_user` ASC),
...
CREATE TABLE IF NOT EXISTS `cgraphz`.`config_server_project` (
  ...
  INDEX `fk_csp_id_config_project_idx` (`id_config_project` ASC),
  INDEX `fk_csp_id_config_server_idx` (`id_config_server` ASC),
...
CREATE TABLE IF NOT EXISTS `cgraphz`.`perm_project_group` (
  ...
  INDEX `fk_ppg_id_config_project_idx` (`id_config_project` ASC),
  INDEX `fk_ppg_id_auth_group_idx` (`id_auth_group` ASC),
...
CREATE TABLE IF NOT EXISTS `cgraphz`.`perm_module_group` (
  ...
  INDEX `fk_pmg_id_auth_group_idx` (`id_auth_group` ASC),
  INDEX `fk_pmg_id_perm_module_idx` (`id_perm_module` ASC),
...
CREATE TABLE IF NOT EXISTS `cgraphz`.`config_role_server` (
  ...
  `id_config_server` INT UNSIGNED NOT NULL,
  INDEX `fk_crs_id_config_role_idx` (`id_config_role` ASC),
  PRIMARY KEY (`id_config_role`, `id_config_server`),
  INDEX `fk_crs_id_config_server_idx` (`id_config_server` ASC),
...
CREATE TABLE IF NOT EXISTS `cgraphz`.`config_plugin_filter_group` (
  ...
  INDEX `fk_cpfg_id_auth_group_idx` (`id_auth_group` ASC),
...
CREATE TABLE IF NOT EXISTS `cgraphz`.`config_environment_server` (
  ...
  INDEX `fk_ces_id_config_environnement_idx` (`id_config_environment` ASC),
  INDEX `fk_ces_id_config_server_idx` (`id_config_server` ASC),
...
CREATE TABLE IF NOT EXISTS `cgraphz`.`config_dynamic_dashboard_content` (
  ...
  INDEX `fk_cddc_id_config_dynamic_content_idx` (`id_config_dynamic_dashboard` ASC),
...
CREATE TABLE IF NOT EXISTS `cgraphz`.`config_dynamic_dashboard_group` (
  ...
  INDEX `fk_cddg_id_auth_group_idx` (`id_auth_group` ASC),
  INDEX `fk_cddg_id_config_dynamic_dashboard_idx` (`id_config_dynamic_dashboard` ASC),
