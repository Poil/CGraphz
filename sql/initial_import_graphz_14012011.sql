...
SET AUTOCOMMIT=0;
USE `cgraphz`;
INSERT INTO `cgraphz`.`perm_module` (`id_perm_module`, `module`, `component`) VALUES ('1', 'perm', 'module');
INSERT INTO `cgraphz`.`perm_module` (`id_perm_module`, `module`, `component`) VALUES ('2', 'config', 'dashboard');
INSERT INTO `cgraphz`.`perm_module` (`id_perm_module`, `module`, `component`) VALUES ('3', 'config', 'template');
INSERT INTO `cgraphz`.`perm_module` (`id_perm_module`, `module`, `component`) VALUES ('4', 'config', 'project');
INSERT INTO `cgraphz`.`perm_module` (`id_perm_module`, `module`, `component`) VALUES ('5', 'config', 'server');
INSERT INTO `cgraphz`.`perm_module` (`id_perm_module`, `module`, `component`) VALUES ('6', 'dashboard', 'view');
INSERT INTO `cgraphz`.`perm_module` (`id_perm_module`, `module`, `component`) VALUES ('7', 'auth', 'user');
INSERT INTO `cgraphz`.`perm_module` (`id_perm_module`, `module`, `component`) VALUES ('8', 'auth', 'group');
